...
class Popup {
	...
	eventsPopup() {
		...
		document.addEventListener("click", function (e) {
			...
			if (buttonOpen && !e.target.closest('.card-box__icon-close')) {
				e.preventDefault();
			...
			if (buttonClose || !e.target.closest(`.${this.options.classes.popupContent}`) && this.isOpen &&
				!e.target.closest('.header__filter-box') && !e.target.closest('.header__search-box') && !e.target.closest('.header__title-box')) {
				e.preventDefault();
				this.close();
				return;
			}
